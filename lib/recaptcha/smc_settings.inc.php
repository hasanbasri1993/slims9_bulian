...
$sysconf['captcha']['smc']['publickey'] = '6LcioE0hAAAAAIE9xekIdofaxSNNVLUfJtIH1mnf'; // some captcha providers need this. Ajdust it with yours
$sysconf['captcha']['smc']['privatekey'] = '6LcioE0hAAAAAFs4iafy9rFzs6LiycVVD8zq9BqC'; // some captcha providers need this. Ajdust it with yours
