...
$sysconf['captcha']['smc']['publickey'] = CAPTCHA_PUBLICKEY; // some captcha providers need this. Ajdust it with yours
$sysconf['captcha']['smc']['privatekey'] = CAPTCHA_PRIVATEKEY; // some captcha providers need this. Ajdust it with yours
