...
$sysconf['captcha']['member']['publickey'] = CAPTCHA_PUBLICKEY; // some captcha providers need this. Ajdust it with yours
$sysconf['captcha']['member']['privatekey'] = CAPTCHA_PRIVATEKEY; // some captcha providers need this. Ajdust it with yours
